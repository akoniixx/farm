import { View, Text ,Modal, StyleSheet, Image, Platform, TouchableOpacity } from 'react-native'
...
const RegisterFailedNotification : React.FC<RegisterFailedModalNotiFication> = ({onClick,onClose,value}) => {
  return (
    <Modal 
        transparent={true}
        visible={value}
