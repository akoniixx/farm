...
const RegisterFailedModal: React.FC<RegisterFailedModalNotiFication>  = ({onClick,onClose,value}) => {
  return (
    <Modal
        transparent={true}
        visible={value}
    >
        <View style={styles.modal}>
            <View style={styles.modalBg}>
                ...
                <Image source={image.registerfailednoti} style={{
                    marginVertical : normalize(20)
                }}/>
                <Text style={styles.modalHeader}>
                    ท่านยืนยันตัวตนไม่สำเร็จ
                </Text>
                ...
                <View style={{
                    ...
                    <MainButton label='ติดต่อเจ้าหน้าที่' color={colors.orange} fontColor={colors.white} onPress={onClick}/>
                </View>
            </View>
        </View>
    </Modal>
