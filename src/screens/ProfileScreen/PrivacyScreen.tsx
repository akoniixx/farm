            ...
            <ScrollView>
              ...
              <View>
                <Text
                  ...
                  นโยบายความเป็นส่วนตัวของ Icon Kaset Co., Ltd. นี้
                  (“ไอคอนเกษตร” หรือ “เรา” “พวกเรา” หรือ “ของเรา”)
                  ใช้กับการดำเนินการไม่ว่า
                  ...
                  หรือผู้ใช้แต่ละคนของบริการ (“ท่าน” หรือ “ของท่าน” หรือ
                  “ผู้ใช้”) ซึ่งในนโยบาย ความเป็นส่วนตัวนี้ (“นโยบาย”)
                  ได้ชี้แจ้ง รายละเอียดว่า ข้อมูลใดบ้างที่เราเก็บรวบรวม
                  และนำไปใช้ทำอะไร โดยเราให้ความสำคัญกับ
                  ...
                  และการทำคำสั่งเกี่ยวกับบริการของท่าน ตัวอย่างเช่น
                  ชื่อของผู้ส่ง หมายเลขโทรศัพท์ของผู้ส่ง ชื่อของผู้รับ
                  ที่อยู่ของผู้รับ หมายเลขโทรศัพท์ของผู้รับ สิ่งของ
                  ข้อมูลร้านค้า ที่อยู่ของสถานที่จัดส่งและประวัติการสั่งซื้อ
                  ที่อยู่อีเมล ประเภทการชำระเงิน ข้อมูลบัญชีธนาคาร
                  (ชื่อเจ้าของบัญชี หมายเลขบัญชี ชื่อธนาคาร)
