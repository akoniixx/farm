...
const UploadDronerLicenseScreen: React.FC<any> = ({ navigation, route }) => {
   const dronerLicense=route.params.dronerLicense
    ...
    const getImg =async () => {
        ...
        ProfileDatasource.getImgePath(droner_id!, dronerLicense.path)
        .then((res)=>{
            setImageURL(res.url)
        })
    }
                    ...
                    {image == null||dronerLicense!== undefined?  (
                        ...
                        <View style={{
                            ...
                            <View style={{ alignItems: 'center', flexDirection: 'row' }}>
                                <Image
                                    source={{ uri:image == null&&dronerLicense!== undefined?imageURL: image.assets[0].uri }}
                                    style={{
                                        width: normalize(36),
                                        height: normalize(36),
                                ...
                                <View style={{ width: '70%', marginLeft: 10 }}>
                                    <Text ellipsizeMode="tail" numberOfLines={1}>{image == null&&dronerLicense!== undefined?dronerLicense.fileName:image.assets[0].fileName}</Text>
