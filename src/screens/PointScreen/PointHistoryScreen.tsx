...
import { getAllHistoryPoint, historyPoint } from '../../datasource/HistoryPointDatasource';
...
const DetailPointScreen: React.FC<any> = ({ navigation, route }) => {
    ...
    return (
        <View
            ...
            <LinearGradient colors={['#FA7052', '#F89132']} start={{ x: 0, y: 0.5 }} end={{ x: 1, y: 0.5 }} style={{ alignItems: 'center', paddingVertical: normalize(10) }}>
