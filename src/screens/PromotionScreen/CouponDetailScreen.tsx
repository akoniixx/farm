            ...
            <View style={{
                ...
                <View style={styles.couponRemain}>
                    ...
                    <View style={{
                        ...
                        <Text style={[styles.header,{color : colors.orange}]}>{detail.keep}</Text>
                ...
                <LinearGradient
                  ...
                  start={{ x: 0.14, y: 0.85 }}
                  style={[styles.couponScore,{width : `${((detail.keep)/detail.count*100)}%`}]} />
                </View>
            </View>:<></>
        }
        <View style={styles.content}>
            <Text style={[styles.header,{paddingBottom : normalize(10)}]}>ช่วงเวลาที่ใช้งานได้</Text>
            <Text style={styles.description}>
                {generateYearTime(detail.startDate)+ " ถึง "+ generateYearTime(detail.expiredDate)}
            </Text>
            ...
            <HTML 
                ...
                tagsStyles={htmlStyle}
            />
            <Text style={[styles.header,{paddingBottom : normalize(10)}]}>เงื่อนไขการใช้คูปอง</Text>
            {
                ...
                <View style={{
                    ...
                    <Text style={styles.description}>{`\u2022  ${checkRaiFull(detail.couponConditionRaiMin,detail.couponConditionRaiMax)}`}</Text>
                </View>:<></>
            }
            {
                ...
                <View style={{
                    ...
                    <Text style={[styles.description]}>{`\u2022  ${checkService(detail.couponConditionServiceMin,detail.couponConditionServiceMax)}`}</Text>
                </View>:<></>
            }
            {
                ...
                <View style={{
                    ...
                    <Text style={[styles.description]}>{`\u2022  พืชที่ใช้คูปอง ${detail.couponConditionPlantList?.map((item : any) => item.plantName + " ")}`}</Text>
                </View>:<></>
            }
            {
                ...
                <View style={{
                    ...
                    <Text style={[styles.description]}>{`\u2022  จังหวัด ${detail.couponConditionProvinceList?.map((item : string)=> item + " ")}`}</Text>
                </View>:
                 <View style={{
                    paddingHorizontal : normalize(15),
                    flexDirection : 'row',
                    ...
                    <Text style={[styles.description]}>{`\u2022  ใช้ได้ทุกจังหวัด`}</Text>
                </View>
            }
        </View>
    </ScrollView>
