    ...
    <View style={{
        ...
        <View style={{
            ...
            <View style={{
              ...
              <Image source={image.successdrone} style={{
                position : 'absolute',
              ...
              <Image source={image.successimage} style={{
            ...
            <View style={{
              ...
              <Text style={[styles.h1,{marginTop : (windowWidth*14/375)}]}>ยินดีต้อนรับสู่ครอบครัว</Text>
              <Text style={[styles.h1]}>นักบิน IconKaset</Text>
              <Text style={[styles.label,{marginTop : (windowWidth*16/375),textAlign : 'center'}]}>คุณลงทะเบียนนักบินโดรนกับเราเรียบร้อยแล้ว
