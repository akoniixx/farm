...
const mockReward: RewardListType = {
  condition: '<p>เงื่อนไข</p>',
  description: '<p>รายละเอียด</p>',
  expiredExchangeDate: '2021-10-31T17:00:00',
  expiredUsedDate: '2021-10-31T17:00:00',
  imagePath: 'https://picsum.photos/200/300',
  id: '1',
  rewardName: 'ชื่อรีวอร์ด',
  rewardType: 'DIGITAL',
  score: '10000',
  remain: 10,
  amount: 1,
  createAt: '2021-10-31T17:00:00',
  rewardNo: '1',
  digitalCode: '123456789',
  status: 'ACTIVE',
  rewardExchange: '',
  updateAt: '2021-10-31T17:00:00',
};
export default function RewardDetailScreen({ navigation, route }: Props) {
  const { isDigital, id, isReadOnly } = route.params;
